...
function Product() {
  ...
  return (
    <>
      ...
      {/* Header (( Mobile )) */}
      <HeaderMobile title={products[index].titleFa} />
              ...
              <div className="flex flex-col lg:flex-row lg:items-start items-center container mx-auto lg:mx-0">
                ...
                <div className="w-60">
                  ...
                  <div className="flex items-center justify-around md:justify-between md:my-5">
                    <span className="text-sm text-gray-600">انتخاب رنگ :</span>
                  ...
                  <li className="flex gap-x-4 text-sm flex-col my-2">
                    ...
                    <span className="text-gray-500 mr-8 mt-1">
                      {products[index].properties.networks.map((net) => (
                        <p
                          className="inline-block ml-2"
                          key={products[index].properties.networks.indexOf(net)}
                        >
                          {net}
                        </p>
                      ))}
      ...
      {/* Navigator (( Mobile )) */}
      <div className="bg-white shadow-2xl px-5 z-50 sticky bottom-0 left-0 w-full h-16 flex lg:hidden items-center justify-between rounded-t-lg">
